...
<body>
    ...
    <div class="catalog container">
        ...
        <div class="adm_dob">
            <a href="admin_add_na.html">+ Добавить набор</a>
            <a href="admin_addkat_na.html">+ Добавить категорию набора</a>
        </div>
        <div class="filter">
            <a href="">Все наборы</a>
            <a href="">Похудение <img src="image/red.svg" alt="Редактировать"></a>
            <a href="">Поддержание <img src="image/red.svg" alt="Редактировать"></a>
            <a href="">Набор массы <img src="image/red.svg" alt="Редактировать"></a>
        </div>
    </div>
