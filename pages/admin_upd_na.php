    ...
    <div class="item container">
        ...
        <div class="item_txt">
            ...
            <div class="bl2">
                <div class="o1">
                    <h6>Описание</h6>
                    <p>Идеальный набор для тех, кто следит за фигурой и хочет питаться правильно без лишних калорий. В комплект входят три разнообразных блюда, которые обеспечат вас необходимыми нутриентами в течение дня.</p>
                </div>
                <div class="o1">
                    <h6>Состав</h6>
                    <div class="sos_nab">
